...
class sawCMUSphinx4 extends Thread {
    ...
    static {
        System.loadLibrary("sawCMUSphinx4");
    }
    ...
    public void Start(long sphinx4WrapperPointer,
        ...
        try {
            SphinxConfigurationManager = new ConfigurationManager(sawCMUSphinx4.class.getResource(configName));
        } catch (Exception e) {
