...
osaMeshTriangular::osaMeshTriangular() :
...
void osaMeshTriangular::AllocateMemory( size_t nv, size_t nt ){
...
void osaMeshTriangular::DeallocateMemory(){
...
void osaMeshTriangular::Draw( ) const{
...
osaGeometry::Errno osaMeshTriangular::LoadOBJ( const std::string& filename,
					       bool rotateX90 ){
