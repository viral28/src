...
#ifndef _osaLoPoMoCoBoardIO_h
#define _osaLoPoMoCoBoardIO_h
...
public:
    osaLoPoMoCoBoardIO (unsigned int baseAddress = 0x220) {BaseAddress = baseAddress;numTries = 0;}
    /* Set functions */
